...
import com.pengyang.com.web.WebServicePost;
...
//            mAuthTask.execute((Void) null);
    ...
    public class MyThread implements Runnable {
        ...
        public void run() {
            ...
            loginMap.put("username",mUsernameView.getText().toString());
            loginMap.put("password",mPasswordView.getText().toString());
//        info = WebService.executeHttpGet( loginMap,"login/doctor.do");

            info = WebServicePost.executeHttpPost(loginMap,"login/doctor.do");

            Map<String,String > pageMap= new HashMap<>();
            pageMap.put("page","1");
            final String patients = WebService.executeHttpGet( pageMap,"patient/show.do");
//            try {
